...
public class QdlAnhHT {
    ...
    public String getSua(Model model, @RequestParam("id") int id) {
        ...
        model.addAttribute("dl", dl); // Đảm bảo rằng đối tượng 'dl' được thêm vào mô hình
    ...
    public String postSua(@ModelAttribute("dl") AnhHeThong dl, RedirectAttributes redirectAttributes) {
        if (Qdl.NVChuaDangNhap(request))
            return "redirect:/admin/nhanvien/dangnhap";
        dl.setNgaySua(LocalDate.now());
        try {
